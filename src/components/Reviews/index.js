  ...
  return (
    ...
    <div className="reviews-wrap">
        ...
        <div className="reviews_revs">
            ...
            <Review name='Акылбек Осмоналиев' date='8 февраля 2020' text='"Хорошое обслуживание и отличное качество елок! Советую"'/>
            <Review name='Акылбек Осмоналиев' date='17 января 2020' text='"Хорошое обслуживание и отличное качество елок! Советую"'/>
        </div>
    </div>
     </div>
  )
